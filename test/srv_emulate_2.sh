...
tc class add dev eth1 parent 1:1 classid 1:12 htb rate 120kbit ceil 220kbit
tc qdisc add dev eth1 parent 1:12 netem delay 180ms 50ms 50%
...
tc class add dev eth2 parent 1:1 classid 1:12 htb rate 840kbit ceil 440kbit
tc qdisc add dev eth2 parent 1:12 netem delay 70ms 50ms 10%
